### Steps for Demo-03 in your AWS EC2 instance with bash scripts
1. Create a bash script 05_run.sh that builds, runs and remove container and images based on ```Dockerfile1```. In the docker-file you'll find comments on how to script it.
